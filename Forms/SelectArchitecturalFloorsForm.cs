...
{
    public partial class SelectArchitecturalFloorsForm : Form
    {
        // Document Info
        ...
        // Project Info
        public static List<Floor> ArchitecturalFloors { get; private set; }
        public static List<FloorType> ArchitecturalFloorTypes { get; private set; }
        ...
        // Constructor
        public SelectArchitecturalFloorsForm(ExternalCommandData commandData)
        {
            CommandData = commandData;
            UIDocument = commandData.Application.ActiveUIDocument;
            Document = UIDocument.Document;
            ArchitecturalFloors = GetElements.GetArchitecturalFloors(Document);
            ArchitecturalFloorTypes = GetElements.GetArchitecturalFloorTypes(Document);
        ...
        /////////////////////////// Button Methods ///////////////////////////
        private void SelectArchitecturalFloorsForm_Load(object sender, EventArgs e)
        {
            foreach (var floorType in ArchitecturalFloorTypes)
            {
        ...
        private void Button_Calculate_Click(object sender, EventArgs e)
        {
            ...
            var floorDetails = SelectionTool.CalculateFloors(SelectedFloorTypes, ArchitecturalFloors);
        ...
        private void Button_SelectType_Click(object sender, EventArgs e)
        {
            ...
            foreach (var floor in ArchitecturalFloors)
            {
                floor.FloorType = SelectedFloorType;
            }

            TaskDialog.Show("Result",
                $"{ArchitecturalFloors.Count} architectural floors detected and changed to {floorTypeName} floor type");
        }
