...
namespace RevitAddIn
{
    class TOPSIS
    {
        ...
        private bool[] isPositiveCriteria;

        public TOPSIS(double[,] decisionMatrix, double[] weights, bool[] isPositiveCriteria)
        {
        ...
        private void SetIdealSolutions()
        {
            for (int i = 0; i < ColumnCount; i++)
            {
                ...
                {
                    IdealSolution[i] = column.Min();
                    NegativeIdealSolution[i] = column.Max();
                }
            }
        }
